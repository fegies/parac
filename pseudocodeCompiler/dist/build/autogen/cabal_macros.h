...
/* package pseudocodeCompiler-0.1.0.0 */
#define VERSION_pseudocodeCompiler "0.1.0.0"
#define MIN_VERSION_pseudocodeCompiler(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
...
/* package pretty-hex-1.0 */
#define VERSION_pretty_hex "1.0"
#define MIN_VERSION_pretty_hex(major1,major2,minor) (\
  (major1) <  1 || \
  (major1) == 1 && (major2) <  0 || \
...
#define CURRENT_COMPONENT_ID "pseudocodeCompiler-0.1.0.0"

#define CURRENT_PACKAGE_KEY "pseudocodeCompiler-0.1.0.0"
